					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img width="80px" src="{{asset('upload/products/' . $v_content->options->images )}}" alt=""></a>
							</td>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="{{asset('/delete-to-cart/'.$v_content->rowId)}}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
